...
@GetMapping("habilidade/cadastrar/{id}")
  public String cadastrar(@PathVariable String id,//dentificaremos o aluno com que estamos lidando no cadastro de habilidades, e passamos seu id como parâmetro no mapeamento da rota, recuperando-o com a anotação @PathVariable 
		  Model model){
